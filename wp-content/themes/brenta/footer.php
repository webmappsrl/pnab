<div
    ...
    <div class=" et_pb_row banner_footer et_pb_row_3 et_pb_row_fullwidth">
        <div class="banner et_pb_column et_pb_column_2_3  et_pb_column_3">
            <div
              ...
              if ($query->have_posts()) {
                while ($query->have_posts()) {
                  ...
                  if (get_field('immagine_banner')) {
                    ...
                    $image = array('url'=>'/wp-content/themes/brenta/img/banner.jpg', 'alt'=>'');
                  }
                  ...
                  if (get_field('sottotitolo_banner')) {
                    ...
                    <a href="/marchio-di-qualita/ospitalita-qualita-parco/" class="logo_banner">
                        <img src="/wp-content/themes/brenta/img/banner-label.png" alt="logo qualità parco">
                    </a>
                    ...
                    <a href="<?php echo $link_url; ?>" target="<?php echo $link_target; ?>">
                      ...
                      <?php } else { ?>
                          <img src="/wp-content/themes/brenta/img/banner.jpg" alt="">
                      <?php } ?>
                    </a>
                  <?php
                }
        ...
        <div class="newsletter et_pb_column et_pb_column_1_3  et_pb_column_4">
            <div
                class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left  et_pb_text_1">
                <h3><i class="fa fa-envelope-open-o" aria-hidden="true"></i>
                    NEWSLETTER</h3>
                <p><input
