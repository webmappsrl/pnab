...
<div id="totalpoll-support" class="wrap totalpoll-page">
	<div class="totalpoll-page-container">
		...
		<form target="_blank" method="get" action="<?php echo TP_SUPPORT; ?>">
			...
			<input type="hidden" name="utm_source" value="totalpoll-lite">
		...
		<div class="links-cards clearfix">
			<a href="<?php echo TP_SUPPORT; ?>?utm_campaign=support&utm_medium=in-app&utm_source=totalpoll-lite" target="_blank" class="link-card">
			...
			<a href="<?php echo TP_SUPPORT; ?>new-support-ticket/?product=totalpoll-lite&utm_campaign=support&utm_medium=in-app&utm_source=totalpoll-lite" target="_blank" class="link-card">
				<svg width="48" height="48" viewBox="0 0 24 24">
