...
?>
<div id="totalpoll-upgrade" class="totalpoll-page wrap">

	<form method="post" class="totalpoll-page-container">
		<svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 24 24" fill="#dddddd">
			<path
		...
		<h1><?php _e( 'Upgrade to TotalPoll Pro', TP_TD ); ?></h1>

		<p><?php _e( 'Upgrade to TotalPoll Pro now and unlock awesome features.', TP_TD ); ?></p>

		<a href="<?php echo esc_attr( TP_WEBSITE ); ?>" target="_blank" class="button button-primary"><?php _e( 'Upgrade now!', TP_TD ); ?></a>
	</form>
</div>