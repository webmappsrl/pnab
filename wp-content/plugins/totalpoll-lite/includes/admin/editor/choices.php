...
<div class="containables-container" data-tp-container data-tp-choices>
	...
	<ul class="containables-types clearfix">
		...
		<li>
			<button class="button" type="button" disabled><?php _e( 'Video', TP_TD ); ?><?php $this->pro_only(); ?></button>
		</li>
		<li>
			<button class="button" type="button" disabled><?php _e( 'Audio', TP_TD ); ?><?php $this->pro_only(); ?></button>
		</li>
		<li>
			<button class="button" type="button" data-tp-containables-insert value="choices-html" disabled><?php _e( 'Rich', TP_TD ); ?><?php $this->pro_only(); ?></button>
		</li>
		<?php do_action( 'totalpoll/actions/admin/editor/choices/types', $this->poll ); ?>
		<li class="alignright">
			<button class="button" type="button" disabled><?php _e( 'Bulk insertion', TP_TD ); ?><?php $this->pro_only(); ?></button>
			&nbsp;
			<button class="button button-danger" type="button" disabled><?php _e( 'Reset votes', TP_TD ); ?><?php $this->pro_only(); ?></button>
		</li>
	</ul>
