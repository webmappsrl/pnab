...
<div class="wrap">
	<div class="totalpoll-welcome-panel">
		<form id="totalpoll-welcome" action="http://subscribe.misqtech.com/mymail/subscribe?utm_campaign=welcome-box&utm_medium=in-app&utm_source=totalpoll-lite" method="post" target="_blank" onsubmit="hideTotalPollWelcome()">
